...
def calculate_regrets(runtime):
    res = {}
    # ignoring first entry
    res['regret_validation'] = np.arange(start=2, stop=len(runtime)+1, step=1).tolist()
